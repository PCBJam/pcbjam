...
| parked-motion/parked_motion_test | WORKS | 1/1 | Mouse motion delivered while a handler spins in wxYield+wxMilliSleep (KiCad RunSynchronousAction: paste-move follows the cursor) |
